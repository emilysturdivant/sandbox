...
home_dir <- here::here('hih_indonesia')
out_dir <- here::here(home_dir, 'outputs'); dir.create(out_dir, recursive=TRUE)

fp_polys <- '/Volumes/ejs_storage/data/gadm/gadm36_0_tropics_simp001big3.shp'
...
# 500m AGB
agb_dir <- '/Volumes/ejs_storage/data/raw_data/biomass/agb500m_y03_18'
interp_tiles <- list.files(agb_dir, '*\\.tif', full.names = TRUE)
