...
mdg3 <- raster::getData('GADM', country = 'MDG', level = 3)
...
# pas <- st_read('/Users/emilysturdivant/data/protected_areas/WDPA/WDPA_Oct2021_polygons_tropics_simp001.gpkg') %>% 
#   filter(ISO3 == 'MDG')
