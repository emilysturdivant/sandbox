...
df_p %>% saveRDS(here::here(working_dir, 'extracted_vals_SOC.rds'))

df_p <- readRDS(here::here(working_dir, 'extracted_vals_SOC.rds'))
...
# AGB_BGB
df_p <- readRDS(here::here(working_dir, 'extracted_vals_AGB_BGB.rds'))
